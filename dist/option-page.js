...
/* harmony import */ var _helpers_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/api */ "./src/option-page/helpers/api.ts");
...
const App = () => {
    ...
    const { data: posts, isLoading, isError } = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)('posts', _helpers_api__WEBPACK_IMPORTED_MODULE_3__.fetchPosts);
    if (isLoading) {
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "Loading...");
    }
    if (isError) {
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "Error loading posts");
    }
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Plugin Page Settings"),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, { label: "Sample Text Input", value: inputValue, onChange: handleInputChange }),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, { onClick: handleSave }, "Save"),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Posts"),
        posts.map((post) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { key: post.id }, post.title)))));
};
...
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app */ "./src/option-page/app.tsx");



const queryClient = new react_query__WEBPACK_IMPORTED_MODULE_1__.QueryClient();
const Index = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_query__WEBPACK_IMPORTED_MODULE_1__.QueryClientProvider, { client: queryClient },
...
/***/ "./src/option-page/helpers/api.ts":
/*!****************************************!*\
  !*** ./src/option-page/helpers/api.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./entry */ "./src/option-page/entry.tsx");



react_dom__WEBPACK_IMPORTED_MODULE_1___default().render(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_entry__WEBPACK_IMPORTED_MODULE_2__["default"], null), document.getElementById('react-plugin-page'));
