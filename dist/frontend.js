...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/util */ "./src/frontend/helpers/util.ts");
/* harmony import */ var _helpers_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/api */ "./src/frontend/helpers/api.ts");
...
const transformedUrlsResponse = await (0,_helpers_api__WEBPACK_IMPORTED_MODULE_1__.sendPostRequest)(sample_api.url, { urls });
...
const anchorTags = document.getElementById(_conf__WEBPACK_IMPORTED_MODULE_2__.elementId)?.getElementsByTagName('a');
if (anchorTags) {
